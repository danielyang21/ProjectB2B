      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <button className="px-5 py-2 text-sm font-medium text-white bg-slate-900 dark:bg-brand-blue-600 rounded-lg hover:bg-slate-800 dark:hover:bg-brand-blue-700 transition-all duration-200">
